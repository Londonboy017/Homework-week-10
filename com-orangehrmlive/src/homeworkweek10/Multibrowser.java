...
public class Multibrowser {
    ...
    public static void main(String[] args) {
        ...
        WebElement username = driver.findElement(By.id("txtUsername"));//store in WebElement by id
        username.sendKeys("Admin");///Sending email to email filed element
        //to find the password field element
        WebElement passwordFeild = driver.findElement(By.name("txtPassword"));//Store in webelement by name
